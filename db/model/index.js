...
User.belongsToMany(User, { as: 'Idol', through: Follow_People, foreignKey: 'fans_id', targetKey: 'id'})
User.belongsToMany(User, { as: 'Fans', through: Follow_People, foreignKey: 'idol_id', targetKey: 'id'})
